...
function getLogger$1(scope) {
	if (!logger$1) try {
		logger$1 = __require("@nisoku/satori-log").createSatori({
			logLevel: "error",
			enableConsole: true
		}).createLogger(scope);
	} catch {
...
//#endregion
export { COMPONENT_REGISTRY, ICON_SVGS, MODIFIER_MAP, applyCurvomorphism, compileSakko, defaultTokens, enableCurvomorphism, escapeCss, escapeHtml, escapeUrl, generateCSSVariables, generateThemeCSS, getTokenValue, injectThemeCSS, parseModifiers, registerComponents, render, transformAST, unescapeHtml };
